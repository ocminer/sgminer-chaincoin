...
static cl_int queue_chaincoin_mod_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
  cl_kernel *kernel;
  unsigned int num;
  cl_ulong le_target;
...
#define A_DARK(a, b) \
  ...
  A_DARK("chaincoin", chaincoin_regenhash),
...
#undef A_DARK
  ...
  { "chaincoin-mod", ALGO_X11, "", 1, 1, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 10, 8 * 16 * 4194304, 0, chaincoin_regenhash, NULL, NULL, queue_chaincoin_mod_kernel, gen_hash, append_x11_compiler_options },
